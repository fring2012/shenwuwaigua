...
public abstract class OnArenaStrategyImpl implements IStrategy {
    ...
    public void onArena(BufferedImage bi) {
        ...
        if (battlePointRGB == this.battlePointBGR || caiDanRGB == mBGRCollection.getCaiDanBGR()) {
            ...
            if (mCheckStateVO.isHandleDiolog()) {
                ...
                if (mBGRCollection.getDialogCenter() ==
                        mBGRCollection.getPointBGR(bi,mPointCollection.dialogCenter)) {
                ...
                } else if (mBGRCollection.getDialogCenter() ==
                                mBGRCollection.getPointBGR(bi,mPointCollection.dialogSingleButton)) {
    ...
    public boolean isEnoughHp(BufferedImage bi) {
        return BGRCollection.getInstance().getBanHpBGR()
                == BGRCollection.getInstance().getPointBGR(bi,PointCollection.getInstance().banHpZeroPoint) ?
                true : false;
    }
