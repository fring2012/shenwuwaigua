...
public class PointCollection {
    ...
    public Point hpZeroPoint = new Point();//零点Hp的位置
    public Point banHpZeroPoint = new Point();//半血Hp的位置

    public Point bossPoint = new Point();//boss的位置
    ...
    public boolean obtainAllPoint(BufferedImage bi) {
        ...
        obtainBossPoint(bi); //获得BOSS的坐标
        NpcName.alignAllPoint(); //对齐NPC
